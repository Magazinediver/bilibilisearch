  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        ranklist: [
          {
            link : 'https://www.bilibili.com/video/BV1Xi4y1x7eM',
            title : '[何同学]我用一万行备忘录做了个动画...',
            pic : 'https://i0.hdslb.com/bfs/archive/f995d4da2cb83d3952c1fb3ea130af2e4bf9da02.jpg@114w_70h.webp',
            play : '233.3万',
            danmu : '2.0万',
            up : '老师好我叫何同学',
            score : '10000',
